...
function start() {
	...
	instructions.x = 635 * -0.5;
	instructions.y = 30;
	pausescreen.addChild(instructions);
	var goal = new createjs.Bitmap("goal.png");
	goal.x = 800 * -0.5;
	goal.y = -30;
	pausescreen.addChild(goal);
	var credit = new createjs.Bitmap("credit.png");
	credit.x = 555 * -0.5;
	credit.y = 300;
	pausescreen.addChild(credit);
